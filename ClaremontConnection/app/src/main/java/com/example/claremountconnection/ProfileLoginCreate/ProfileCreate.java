...
public class ProfileCreate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textLoginPassword = (TextInputEditText)findViewById(R.id.text_input_login_password);
        textLoginConfirmPassword = (TextInputEditText)findViewById(R.id.text_login_password);
